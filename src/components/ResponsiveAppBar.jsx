...
import { AppBar, IconButton, Container, Menu, Box , Toolbar, Typography, Button, MenuItem} from "@mui/material";
    ...
    <AppBar position="fixed">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box className='navBar' sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }} >
            <IconButton
              size="large"
